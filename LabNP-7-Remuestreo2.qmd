...
Otro paquete que puede ser de utilidad para realizar bootstrap que da un poco más de información, es el paquete `boot`, que se basa en el libro de Davison & Hinkley: _Bootstrap Methods and Their Application_ (Cambridge, 1997).
...
- _Muestreo sobre las observaciones de los datos_. Este sería el esquema más tradicional.
- _Muestreo sobre residuales_. Se hace bootstrap sobre los residuales, y con ellos se calculan las muestras bootstrap de las respuestas. En este caso, se dejan fijos los valores de los predictores, y sólo se cambia el valor de la respuesta. Esto funciona en el contexto donde se considere a los predictores como no aleatorios. 
